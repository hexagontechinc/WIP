...
As Model degradation is moderate (See my article <a href="http://hexagontechinc.com/blog/index.php?controller=post&action=view&id_post=15" target="_blank">http://hexagontechinc.com/AI_V&V</a>) it is evaluated and retrained with new data collected on a monthly basis.
